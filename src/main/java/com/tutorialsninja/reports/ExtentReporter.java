...
public class ExtentReporter {
	...
	sparkReporter.config().setReportName("Bootcamp part 2 Framework report");
	sparkReporter.config().setDocumentTitle("TNReportTitle|Bootcamp_PnTBatch");
	...
	FileInputStream ip = new FileInputStream(System.getProperty("user.dir") + 
			"\\src\\test\\java\\com\\tutorialsninja\\config\\config.properties");
	prop.load(ip);
